...
def main():
    ...
    profile_icon_url = "https://raw.githubusercontent.com/sjpradhan/portfolioproject/master/Icons/user.png"
    ...
    st.set_page_config(page_title="Satyajeet Portfolio", page_icon=profile_icon, layout="wide")
     ...
     # Load Image
    portfolio_icon_url = "https://raw.githubusercontent.com/sjpradhan/portfolioproject/master/Profile/Portfolio%20logo.png"
    response = requests.get(portfolio_icon_url)
